...
def test_create_id(page):
    ...
    page.get_by_role("textbox", name="비밀번호", exact=True).fill("whtjdwn1")
    page.get_by_role("textbox", name="비밀번호 확인").click()
    page.get_by_role("textbox", name="비밀번호 확인").fill("whtjdwn1")
# 2. 로그인
def test_login(page):
    page.get_by_role("button", name="로그인").click()
    ...
    page.get_by_role("textbox", name="비밀번호 입력").fill("whtjdwn1")
...
def test_payment(page):
    ...
    page1.get_by_role("textbox", name="비밀번호").fill("tjdwn111!")
